...
--
-- Host: 127.0.0.1
-- Generation Time: 2017-08-16 11:26:56
-- 服务器版本： 5.6.17
-- PHP Version: 5.5.12
...
(1, 'admin', 1502343141, '::1', '修改网站配置。'),
(2, 'admin', 1502414097, '::1', '登录成功。');
...
('sitename', 'admincms信息管理系统', 0, ''),
('title', 'admincms信息管理系统', 0, ''),
('keywords', '管理系统', 0, ''),
('description', 'admincms信息管理系统', 0, ''),
('footer', '@admincms', 0, ''),
('test', '测试', 1, '测试变量');
