    ...
    <div class="ace-settings-container" id="ace-settings-container">
        ...
        <div class="ace-settings-box clearfix" id="ace-settings-box">
            ...
            <div class="pull-left width-50">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <form class="form-horizontal" enctype="multipart/form-data" id="form" method="POST" action="<?php echo U('add');?>">
...
<!--                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <select name="course" id="province">
                                        <?php if(is_array($province)): $i = 0; $__LIST__ = $province;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option  value="<?php echo ($vo["id"]); ?>" <?php if($vo["id"] == $quest['kid']): ?>selected="selected"<?php endif; ?>
                             ...
                             <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="did" id="keywords" placeholder="视频所属知识点"
                                               class="col-xs-10 col-sm-5" value="<?php echo ($did); ?>">
                                    <span class="help-inline col-xs-12 col-sm-7">
                            ...
                            <div class="space-4"></div>
                            <?php if($videonum != ''): ?><div class="form-group">
                                <label class="col-sm-1 control-label no-padding-right" for="form-field-2">视频编号</label>
                                <div class="col-sm-9">
                                    <input type="text" name="videonum" id="keywords" placeholder="视频编号"
                                               class="col-xs-10 col-sm-5" value="<?php echo ($videonum); ?>">
                                    <span class="help-inline col-xs-12 col-sm-7">
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="teachername" id="keywords" placeholder="主讲老师"
                                               class="col-xs-10 col-sm-5" value="<?php echo ($quest['keywords']); ?>">
                                    <span class="help-inline col-xs-12 col-sm-7">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                   ...
                                   <div id='thumb-img' style="margin: 10px;"></div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                   <input type="file" name='filevedio' />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                   <input type="radio" name='groom' value="1" checked />否
                                   <input type="radio" name='groom' value="2" />是
                                </div>
                            </div>
                             <div class="space-4"></div>
                            <div class="form-group">
                                <label class="col-sm-1 control-label no-padding-right" for="form-field-1">是否课堂录制</label>
                                <div class="col-sm-9">
                                   <input type="radio" name='rec' value="1" checked />否
                                   <input type="radio" name='rec' value="2" />是
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9" style='margin-top: 6px;'>
                                    <input type="radio" name="type" value='1' checked>否
