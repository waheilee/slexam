            ...
            <div class="pull-left width-50">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="row">
                            <form id="form" method="post" action="<?php echo U('delbegin');?>">
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <?php if(is_array($begin)): $i = 0; $__LIST__ = $begin;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                                            <td class="center">
                                            ...
                                            <td class="center">
                                                <a class="del" href="javascript:;"  val="<?php echo U('delbegin',array('uids'=>$val['id']));?>"
                                                                                     title="删除">删除</a>
                                            </td>
