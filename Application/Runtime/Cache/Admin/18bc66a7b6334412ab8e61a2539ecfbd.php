                        ...
                        <div class="row">
                            <form id="form" method="post" action="<?php echo U('del');?>">
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <?php if(is_array($vcr)): $i = 0; $__LIST__ = $vcr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                                            <td class="center">
                                            ...
                                            <td >
                                             ...
                                             <td ><?php echo ($val['did']); ?></td>
                                              <td ><?php echo ($val['handnum']); ?></td>
                                              <td >
                                                   <?php if($val['pay'] == 1): ?>众筹方式
                                                  <?php else: ?>
                                                  私人定制<?php endif; ?>
                                              </td>
                                              <td>
                                              <?php if($val['status'] == 0 ): ?><a href="<?php echo U('status',array('id'=>0,'orderid'=>$val['id']));?>" title="点击录制">未审核</a>
                                        <?php elseif($val['status'] == 1): ?><a href="<?php echo U('video/add',array('did'=>$val['did'],'ordernum'=>$val['ordernum']));?>" title="点击上传该录制好的视频">录制中</a>
                                        <?php else: ?>
                                       已完成<?php endif; ?>
                                           </td>
                                           <td ><?php echo ($val['ordernum']); ?></td>
                                               <td ><?php echo (msubstr($val['remark'],0,10,'utf-8',false)); ?></td>
                                            <td class="center">
                                                <a class="del" href="javascript:;"  val="<?php echo U('del',array('uids'=>$val['id']));?>"
                                                                                     title="删除">删除</a>
                                            </td>
