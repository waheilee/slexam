                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="row">
                            <form class="form-inline" action="" method="get">
                                ...
                                <label class="inline">所属科目</label>
                                    <select name="courseid" id="province" class="form-control">
                                        <option value="" >课程</option>
                                        <?php if(is_array($province)): $i = 0; $__LIST__ = $province;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option  value="<?php echo ($vo["id"]); ?>" <?php if($vo["id"] == $_GET['courseid']): ?>selected="selected"<?php endif; ?>><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                    </select>   
                                <label class="inline">标题</label>
                                <input type="text" name="keywords" value="<?php echo ($_GET['keywords']); ?>" class="form-control">
                            ...
                            <form id="form" method="post" action="<?php echo U('del');?>">
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <th class="center">所属知识点</th>
                                        <th class="center">视频编码</th>
                                    ...
                                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                                            ...
                                            <td class="center"> 
                                                <?php if(is_array($province)): $i = 0; $__LIST__ = $province;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$value): $mod = ($i % 2 );++$i; if($val['kid'] == $value['id']): echo ($value['name']); endif; endforeach; endif; else: echo "" ;endif; ?>
                                            </td>
                                            <td class="center"><?php echo ($val['videonum']); ?></td>
                                            <td class="center">
                                                <a href="<?php echo U('edit',array('id'=>$val['id']));?>">修改</a>&nbsp;
                                                <a class="del" href="javascript:;"  val="<?php echo U('del',array('uids'=>$val['id']));?>" title="删除">删除</a>
                                            </td>
