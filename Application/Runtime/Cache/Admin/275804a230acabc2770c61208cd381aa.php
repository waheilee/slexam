...
<body class="no-skin">
    ...
    <!-- /section:basics/navbar.layout -->
<link href="/www/slcms/Public/admin/css/common.css" type="text/css" rel="stylesheet">
<link href="/www/slcms/Public/admin/css/index.css" type="text/css" rel="stylesheet">
<script src="/www/slcms/Public/admin/js/imgUp.js"></script>
    ...
    <div class="ace-settings-container" id="ace-settings-container">
        ...
        <div class="ace-settings-box clearfix" id="ace-settings-box">
            ...
            <div class="pull-left width-50">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <form class="form-horizontal" enctype="multipart/form-data" id="form" method="POST" action="<?php echo U('update');?>">
                            <input type="hidden" name="id" value="<?php echo ($video["id"]); ?>" id="id"/>
<!--                            <div class="form-group">
                                <label class="col-sm-1 control-label no-padding-right" for="form-field-0">题目分类</label>
                                <div class="col-sm-9">
                                    <select name="course" id="province">
                                        <?php if(is_array($province)): $i = 0; $__LIST__ = $province;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option  value="<?php echo ($vo["id"]); ?>" <?php if($vo["id"] == $video['kid']): ?>selected="selected"<?php endif; ?>
                            ...
                            <div class="form-group">
                                <label class="col-sm-1 control-label no-padding-right" for="form-field-1">视频标题</label>
                                <div class="col-sm-9">
                                    <input type="text" name="title" id="title" placeholder="视频标题"
                                               class="col-xs-10 col-sm-5" value="<?php echo ($$video["title"]); ?>">
                                    <span class="help-inline col-xs-12 col-sm-7">
                                        <span class="middle">视频标题不能为空。</span>
                                    </span>
                                </div>
                            </div>
                             <div class="space-4"></div>
                             <div class="form-group">
                                <label class="col-sm-1 control-label no-padding-right" for="form-field-2">视频所属知识点</label>
                                <div class="col-sm-9">
                                    <input type="text" name="did" id="keywords" placeholder="视频所属知识点"
                                               class="col-xs-10 col-sm-5" value="<?php echo ($$video["did"]); ?>">
                                    <span class="help-inline col-xs-12 col-sm-7">
                                        <span class="middle">视频所属知识点，<p style="color: red;">多个知识点请用中文状态下的逗号分隔。</p></span>
                                    </span>
                                </div>
                            </div>
                            <div class="space-4"></div>
                             ...
                             <div class="form-group">
                                <label class="col-sm-1 control-label no-padding-right" for="form-field-2">视频编号</label>
                                <div class="col-sm-9">
                                    <input type="text" name="videonum" id="keywords" placeholder="视频编号" readonly="readonly"
                                               class="col-xs-10 col-sm-5" value="<?php echo ($video["videonum"]); ?>">
                                    <span class="help-inline col-xs-12 col-sm-7">
                                        <span class="middle">视频编号不能为空。</span>
                                    </span>
                                </div>
                            </div>
                            <div class="space-4"></div>
                              ...
                              <div class="form-group">
                                <label class="col-sm-1 control-label no-padding-right" for="form-field-2">主讲老师</label>
                                <div class="col-sm-9">
                                    <input type="text" name="teachername" id="keywords" placeholder="主讲老师"
                                               class="col-xs-10 col-sm-5" value="<?php echo ($video["teachername"]); ?>">
                                    <span class="help-inline col-xs-12 col-sm-7">
                                        <span class="middle">主讲老师不能为空。</span>
                                    </span>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                   <button type="button" id="thumb" style="margin: 10px;">选择图片</button>
                                   <div id='thumb-img' style="margin: 10px;">
                                        <input type="hidden" name='pic' value="<?php echo ($video["thumb"]); ?>">
                                       <img src="/www/slcms<?php echo ($video["thumb"]); ?>" alt="">
                                   </div>
                                </div>
                            </div>
                            ...
                            <div class="space-4"></div>
                            <div class="form-group">
                                <label class="col-sm-1 control-label no-padding-right" for="form-field-1">视频</label>
                                <div class="col-sm-9">
                                   <input type="file" name='file' value=""/>
                                   <input type="hidden" name='old_file' value="<?php echo ($video['url']); ?>"/>
                                </div>
                            </div>
                            
                            <div class="space-4"></div>
                            <div class="form-group">
                                <label class="col-sm-1 control-label no-padding-right" for="form-field-1">是否重点推荐</label>
                                <div class="col-sm-9" style='margin-top:6px'>
                                   <input type="radio" name='groom' <?php echo ($video['groom'] == 1 ? 'checked' : ''); ?> value="1" />否
                                   <input type="radio" name='groom' <?php echo ($video['groom'] == 2 ? 'checked' : ''); ?> value="2" />是
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="keywords" id="keywords" placeholder="关键词" class="col-xs-10 col-sm-5" value="<?php echo ($video['keywords']); ?>">
                                    <span class="help-inline col-xs-12 col-sm-7">
                            ...
                            <div class="space-4"></div>
                            <div class="form-group">
                                <label class="col-sm-1 control-label no-padding-right" for="form-field-2">是否收费</label>
                                <div class="col-sm-9" style='margin-top: 6px;'>
                                    <input type="radio" name="type" <?php echo ($video['type'] == 1 ? 'checked' : ''); ?> value='1'  >否
                                    <input type="radio" name="type" <?php echo ($video['type'] == 2 ? 'checked' : ''); ?> value='2' >是
                                </div>
                            </div>
                            <div class="space-4"></div>
                            <div class="col-md-offset-2 col-md-9">
                                <button class="btn btn-info submit" type="button"> <i class="icon-ok bigger-110"></i>
                                    保存
                                </button>
                                &nbsp; &nbsp; &nbsp;
...
<script src="/www/slcms/Public/Admin/js/plupload/js/plupload.full.min.js" type="text/javascript" charset="utf-8"></script>
<script type="text/javascript">
    var uuur = "/www/slcms/";
    var uuul = "<?php echo U('upload');?>";
    $(function () {
        $("#tabs").tabs();
        var editor = KindEditor.create('textarea[name="explain"]', {
            uploadJson: '/www/slcms/Public/kindeditor/php/upload_json.php',
            fileManagerJson: '/www/slcms/Public/kindeditor/php/file_manager_json.php',
...
<script src='/www/slcms/Public/Admin/js/news.js'></script>
</body>
</html>