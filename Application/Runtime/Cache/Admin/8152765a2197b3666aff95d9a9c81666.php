            ...
            <div class="pull-left width-50">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="row">
                            <form class="form-inline" action="" method="get">
                             ...
                             <label class="inline">所属知识点</label>
                                <input type="text" name="knowledge" value="<?php echo I(knowledge);?>" class="form-control">
                             <label class="inline">题目</label>
                                <input type="text" name="keywords" value="<?php echo I(keywords);?>" class="form-control">
                        ...
                        <div class="row">
                            <form id="form" method="post" action="<?php echo U('delorder');?>">
                                <table class="table table-striped table-bordered table-hover">
                                    <thead>
                                    <tr>
                                        <th class="center"><input class="check-all" type="checkbox" value=""></th>

                                        <th class="center">参与定制昵称</th>
                                         <th class="center">定制视频课程</th>
                                    ...
                                    <?php if(is_array($handlist)): $i = 0; $__LIST__ = $handlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                                            <td class="center">
                                             <input class="uids" type="checkbox"  name="uids[]" value="<?php echo ($val['id']); ?>"> 
                                            </td>
                                            <td class="center"> <?php echo ($val['username']); ?> </td>
                                            <td class="center">
                                                <?php if(is_array($course)): $i = 0; $__LIST__ = $course;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$va): $mod = ($i % 2 );++$i; if($va['id'] == $val['kid']): echo ($va['name']); endif; endforeach; endif; else: echo "" ;endif; ?>
                                            </td>
                                            <td class="center">
                                                <?php if(is_array($chapter)): $i = 0; $__LIST__ = $chapter;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$value): $mod = ($i % 2 );++$i; if($value['id'] == $val['zid']): echo ($value['name']); endif; endforeach; endif; else: echo "" ;endif; ?>
                                            </td>
                                            <td class="center">
                                                <?php if(is_array($point)): $i = 0; $__LIST__ = $point;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$valu): $mod = ($i % 2 );++$i; if($valu['id'] == $val['jid']): echo ($valu['name']); endif; endforeach; endif; else: echo "" ;endif; ?>
                                            </td>
                                             <td class="center"><?php echo ($val['did']); ?></td>
                                              <td class="center"><?php echo (date("Y-m-d H:i:s",$val['pordertime'])); ?></td>
                                              <td class="center"><?php echo ($val['handnum']); ?></td>
                                               <td class="center"><?php echo ($val['ordername']); ?></td>
                                            <td class="center">
                                                <a class="del" href="javascript:;"  val="<?php echo U('delorder',array('uids'=>$val['id']));?>"
                                                                                     title="删除">删除</a>
                                            </td>
