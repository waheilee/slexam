                                        ...
                                        <fieldset>
                                            ...
                                            <label class="block clearfix">
														<span class="block input-icon ">
															...
															<img style="cursor:pointer;" src="<?php echo U('login/verify');?>"
                                                                 width="163" height="50" title="看不清楚？点击刷新"
                                            ...
                                            <div class="space-4"></div>
                                                <button type="submit" style='background: gray;'>
                                                    <i class="ace-icon fa fa-key"></i>
                                                    <span class="bigger-110" ><a href="<?php echo U('login/indexregister');?>"> 注册</a></span>
                                                </button>
                                            <div class="space-4"></div>
                                        </fieldset>
                                    </form>
...
<script type="text/javascript">
    window.jQuery || document.write("<script src='/www/slcms/Public/qwadmin/js/jquery.js'>" + "<" + "/script>");
</script>
...
<!--[if IE]>
<script type="text/javascript">
    window.jQuery || document.write("<script src='/www/slcms/Public/qwadmin/js/jquery1x.js'>" + "<" + "/script>");
</script>
<![endif]-->
<script type="text/javascript">
    if ('ontouchstart' in document.documentElement) document.write("<script src='/www/slcms/Public/qwadmin/js/jquery.mobile.custom.js'>" + "<" + "/script>");
</script>
