                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="row">
                            <form class="form-inline" action="" method="get">
                               ...
                               课程 <input type="text" name="keywords" value="<?php echo I(keywords);?>" class="form-control">
                            ...
                            <form id="form" method="post" action="<?php echo U('del');?>">
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                                            ...
                                            <td class="center"><a href="<?php echo U('edit',array('uid'=>$val['id']));?>">修改</a>&nbsp;
                                                <?php if($val['uid'] != 1): ?><a class="del" href="javascript:;"
                                                                                     val="<?php echo U('del',array('uids'=>$val['id']));?>"
